...
class StarForceSimulator:
    ...
    def set_options(self, level=160, target_star=22, safeguard=False, spare_cost=0, 
                    shining_full=False, shining_half=False, sunday30=False, sunday100=False, sunday1plus1=False, 
                    mvp_discount=0.0, pc_discount=False):
        self.level = level
    ...
    def get_probabilities(self, star):
    ...
    def get_expected_values(self, start_star=0):
